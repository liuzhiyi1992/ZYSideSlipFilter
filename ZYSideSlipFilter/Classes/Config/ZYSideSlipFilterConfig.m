...
NSString * const FILTER_BACKGROUND_COVER_COLOR = @"000000";
CGFloat    const FILTER_BACKGROUND_COVER_ALPHA = .6f;

//Notification
NSString * const FILTER_NOTIFICATION_NAME_RESET_DATA = @"FILTER_NOTIFICATION_NAME_RESET_DATA";
